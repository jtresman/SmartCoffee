 ...
 */
public class BluetoothSerialService extends Activity {
    // Debugging
...
//        mHandler.sendMessage(msg);
     ...
     * @see com.example.android.bluetoothchat.BluetoothSerialService.ConnectedThread#write(byte[])
     */
...
//        mHandler.sendMessage(msg);
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            Log.i(TAG, "BEGIN mConnectThread Device");
